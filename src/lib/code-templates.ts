...
function getCardClasses(styleId: string, _variantId: string): string {
  const base: Record<string, string> = {
    ...
    claymorphism: "p-6 rounded-3xl bg-purple-100 shadow-[8px_8px_16px_#d1d5db,-4px_-4px_12px_#ffffff,inset_2px_2px_4px_rgba(255,255,255,0.6),inset_-1px_-1px_3px_rgba(0,0,0,0.1)]",
...
function getButtonClasses(styleId: string, _variantId: string): string {
  const base: Record<string, string> = {
    ...
    claymorphism: "px-6 py-2.5 rounded-2xl bg-purple-200 shadow-[4px_4px_8px_#d1d5db,-2px_-2px_6px_#ffffff,inset_1px_1px_2px_rgba(255,255,255,0.5)] active:shadow-[inset_2px_2px_4px_#d1d5db] transition",
...
function getInputClasses(styleId: string, _variantId: string): string {
  const base: Record<string, string> = {
    ...
    claymorphism: "w-full px-4 py-2.5 rounded-2xl bg-purple-50 shadow-[inset_2px_2px_4px_#d1d5db,inset_-1px_-1px_3px_#ffffff] focus:shadow-[inset_3px_3px_6px_#d1d5db,inset_-2px_-2px_4px_#ffffff] outline-none transition",
